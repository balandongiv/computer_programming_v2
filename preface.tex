...
Apart from the lecture materials, this tutorial series is designed to provide a practical, hands-on introduction to computer programming using Python. The focus is on building a strong foundation in programming concepts while applying them to a consistent dataset—the Iris dataset. This approach allows students to see the progression of their skills as they work through increasingly complex tasks, ultimately leading to the development of a rule-based classifier.
...
\begin{itemize}
    ...
    \item To avoid installation issues, we will use \href{https://github.com/features/codespaces}{Github Codespaces} for all coding exercises, ensuring that students can focus on learning rather than troubleshooting their development environment.
\end{itemize}

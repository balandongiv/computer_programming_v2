"""Classifier 10: Detect 'setosa' using a specific rule."""

def predict(sample):
    # Rule 10: Just a silly variation for demonstration
    threshold = 1.0 + (10 * 0.1)
...
if __name__ == "__main__":
    print(f"Classifier 10 Accuracy: {evaluate(dataset)}")
